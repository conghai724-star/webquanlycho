...
INSERT INTO `areas` (`id`, `area_name`, `block`, `lot`, `description`, `created_at`, `updated_at`, `market_id`) VALUES
...
CREATE TABLE `bills` (
  ...
  `electric_amount` decimal(15,2) NOT NULL DEFAULT 0.00,
  `water_amount` decimal(15,2) NOT NULL DEFAULT 0.00,
  `management_fee` decimal(15,2) NOT NULL DEFAULT 0.00,
  `sanitation_fee` decimal(15,2) NOT NULL DEFAULT 0.00,
  `security_fee` decimal(15,2) NOT NULL DEFAULT 0.00,
  `other_fee` decimal(15,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `bills` (`id`, `contract_id`, `bill_code`, `invoice_date`, `due_date`, `rent_amount`, `electric_amount`, `water_amount`, `management_fee`, `sanitation_fee`, `security_fee`, `other_fee`, `total_amount`, `paid_amount`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `business_lines` (`id`, `line_code`, `line_name`, `description`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `contracts` (`id`, `trader_id`, `stall_id`, `contract_number`, `name`, `description`, `contract_file`, `start_date`, `end_date`, `deposit`, `status_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `contract_appendices` (`id`, `contract_id`, `appendix_number`, `name`, `sign_date`, `effect_date`, `content`, `file`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `document_types` (`id`, `type_code`, `type_name`, `description`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `food_safety_inspections` (`id`, `inspection_title`, `inspection_team`, `planned_date`, `actual_date`, `status`, `notes`, `created_at`, `market_id`) VALUES
...
CREATE TABLE `food_safety_violations` (
  ...
  `penalty_measure` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `food_safety_violations` (`id`, `trader_id`, `inspection_id`, `violation_code`, `violation_date`, `description`, `penalty_measure`, `status`, `resolved_date`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `markets` (
  ...
  `status_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
...
INSERT INTO `markets` (`id`, `market_code`, `name`, `phone`, `email`, `manager_name`, `logo`, `province_id`, `district_id`, `ward_id`, `latitude`, `longitude`, `status_code`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `market_map_elements` (
  ...
  `waypoints` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stroke_width` int(11) DEFAULT 24
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `market_map_elements` (`id`, `element_type`, `element_name`, `stall_id`, `pos_x`, `pos_y`, `width`, `height`, `rotation`, `color`, `waypoints`, `stroke_width`) VALUES
...
INSERT INTO `receipts_payments` (`id`, `transaction_code`, `type`, `amount`, `transaction_date`, `category`, `note`, `reference_id`, `created_by`, `created_at`, `market_id`) VALUES
...
CREATE TABLE `stalls` (
  ...
  `map_coordinate_x` int(11) DEFAULT NULL,
  `map_coordinate_y` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `stalls` (`id`, `area_id`, `stall_code`, `stall_type_id`, `area_size`, `base_price`, `status_id`, `map_coordinate_x`, `map_coordinate_y`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `stall_types` (`id`, `type_code`, `type_name`, `description`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `system_actors` (`id`, `actor_code`, `actor_name`, `description`) VALUES
...
CREATE TABLE `traders` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `license_file` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `traders` (`id`, `trader_code`, `fullname`, `phone`, `cccd`, `business_line_id`, `address`, `description`, `license_file`, `status_id`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `trader_attp` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_id` int(11) NOT NULL DEFAULT 18,
...
INSERT INTO `trader_attp` (`id`, `trader_id`, `doc_type_id`, `doc_number`, `name`, `description`, `file`, `status_id`, `issuer`, `issue_date`, `expiry_date`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `user_username`, `user_password`, `user_fullname`, `user_email`, `user_is_active`, `user_reset_token`, `user_reset_expires_at`, `user_group`, `user_actor_id`, `user_status`, `user_created_at`, `user_updated_at`) VALUES
...
INSERT INTO `user_markets` (`id`, `user_id`, `market_id`, `role_id`, `created_at`) VALUES
...
INSERT INTO `user_market_permissions` (`id`, `user_id`, `market_id`, `module_code`, `created_at`) VALUES
...
CREATE TABLE `utility_readings` (
  ...
  `electric_old` int(11) NOT NULL,
  `electric_new` int(11) NOT NULL,
  `water_old` int(11) NOT NULL,
...
INSERT INTO `utility_readings` (`id`, `stall_id`, `reading_date`, `electric_old`, `electric_new`, `water_old`, `water_new`, `created_by`, `created_at`) VALUES
...
ALTER TABLE `areas`
  ...
  ADD KEY `idx_areas_market` (`market_id`);
...
ALTER TABLE `contracts`
  ...
  ADD KEY `idx_contracts_stall` (`stall_id`);
...
ALTER TABLE `food_safety_inspections`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_inspections_market` (`market_id`);
...
ALTER TABLE `markets`
  ...
  ADD KEY `idx_market_status` (`status_code`),
  ADD KEY `idx_market_location` (`province_id`,`district_id`);
...
ALTER TABLE `market_map_elements`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_stall` (`stall_id`);
...
ALTER TABLE `receipts_payments`
  ...
  ADD KEY `idx_receipts_market` (`market_id`);
...
ALTER TABLE `stalls`
  ...
  ADD KEY `idx_stalls_area` (`area_id`);
...
ALTER TABLE `system_statuses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_domain_code` (`domain`,`code`),
...
ALTER TABLE `trader_attp`
  ...
  ADD KEY `trader_id` (`trader_id`),
  ADD KEY `status_id` (`status_id`),
  ADD KEY `fk_attp_doc_type` (`doc_type_id`);
...
ALTER TABLE `user_markets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_user_market_role` (`user_id`,`market_id`,`role_id`),
  ADD KEY `market_id` (`market_id`),
  ADD KEY `role_id` (`role_id`),
  ADD KEY `idx_user_markets_query` (`user_id`,`market_id`);
...
ALTER TABLE `user_market_permissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_user_market_module` (`user_id`,`market_id`,`module_code`),
  ADD KEY `market_id` (`market_id`);
...
--
ALTER TABLE `areas`
  ADD CONSTRAINT `fk_areas_market` FOREIGN KEY (`market_id`) REFERENCES `markets` (`id`);

--
-- Các ràng buộc cho bảng `bills`
--
ALTER TABLE `bills`
  ADD CONSTRAINT `bills_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `contracts`
--
ALTER TABLE `contracts`
  ADD CONSTRAINT `contracts_ibfk_1` FOREIGN KEY (`trader_id`) REFERENCES `traders` (`id`),
  ADD CONSTRAINT `contracts_ibfk_2` FOREIGN KEY (`stall_id`) REFERENCES `stalls` (`id`),
  ADD CONSTRAINT `contracts_ibfk_3` FOREIGN KEY (`status_id`) REFERENCES `system_statuses` (`id`);

--
-- Các ràng buộc cho bảng `contract_appendices`
--
ALTER TABLE `contract_appendices`
  ADD CONSTRAINT `contract_appendices_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `food_safety_inspections`
--
ALTER TABLE `food_safety_inspections`
  ADD CONSTRAINT `fk_inspections_market` FOREIGN KEY (`market_id`) REFERENCES `markets` (`id`);

--
-- Các ràng buộc cho bảng `food_safety_violations`
--
ALTER TABLE `food_safety_violations`
  ADD CONSTRAINT `food_safety_violations_ibfk_1` FOREIGN KEY (`trader_id`) REFERENCES `traders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `food_safety_violations_ibfk_2` FOREIGN KEY (`inspection_id`) REFERENCES `food_safety_inspections` (`id`) ON DELETE SET NULL;

--
-- Các ràng buộc cho bảng `market_map_elements`
--
ALTER TABLE `market_map_elements`
  ADD CONSTRAINT `market_map_elements_ibfk_1` FOREIGN KEY (`stall_id`) REFERENCES `stalls` (`id`) ON DELETE SET NULL;

--
-- Các ràng buộc cho bảng `receipts_payments`
--
ALTER TABLE `receipts_payments`
  ADD CONSTRAINT `fk_receipts_market` FOREIGN KEY (`market_id`) REFERENCES `markets` (`id`),
  ADD CONSTRAINT `receipts_payments_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);

--
-- Các ràng buộc cho bảng `stalls`
--
ALTER TABLE `stalls`
  ADD CONSTRAINT `fk_stalls_type` FOREIGN KEY (`stall_type_id`) REFERENCES `stall_types` (`id`),
  ADD CONSTRAINT `stalls_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `areas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `stalls_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `system_statuses` (`id`);
...
--
ALTER TABLE `system_statuses`
  ADD CONSTRAINT `system_statuses_ibfk_1` FOREIGN KEY (`color_id`) REFERENCES `status_colors` (`id`);

--
-- Các ràng buộc cho bảng `traders`
--
ALTER TABLE `traders`
  ADD CONSTRAINT `traders_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `system_statuses` (`id`),
  ADD CONSTRAINT `traders_ibfk_2` FOREIGN KEY (`business_line_id`) REFERENCES `business_lines` (`id`) ON DELETE SET NULL;

--
-- Các ràng buộc cho bảng `trader_attp`
--
ALTER TABLE `trader_attp`
  ADD CONSTRAINT `fk_attp_doc_type` FOREIGN KEY (`doc_type_id`) REFERENCES `document_types` (`id`),
  ADD CONSTRAINT `trader_attp_ibfk_1` FOREIGN KEY (`trader_id`) REFERENCES `traders` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `trader_attp_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `system_statuses` (`id`);

--
-- Các ràng buộc cho bảng `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_actor` FOREIGN KEY (`user_actor_id`) REFERENCES `system_actors` (`id`);

--
-- Các ràng buộc cho bảng `user_markets`
--
ALTER TABLE `user_markets`
  ADD CONSTRAINT `user_markets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_markets_ibfk_2` FOREIGN KEY (`market_id`) REFERENCES `markets` (`id`);

--
-- Các ràng buộc cho bảng `user_market_permissions`
--
ALTER TABLE `user_market_permissions`
  ADD CONSTRAINT `user_market_permissions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_market_permissions_ibfk_2` FOREIGN KEY (`market_id`) REFERENCES `markets` (`id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `utility_readings`
--
ALTER TABLE `utility_readings`
  ADD CONSTRAINT `utility_readings_ibfk_1` FOREIGN KEY (`stall_id`) REFERENCES `stalls` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `utility_readings_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);
COMMIT;
