...
?>
        <tr style="border-bottom: 1px solid var(--border-color);" data-trader-row="<?php echo $trader['trader_id']; ?>">
            ...
            <td style="padding: 14px 16px; font-weight: 600; color: var(--text-heading);">
                <?php echo htmlspecialchars($trader['trader_fullname']); ?>
            </td>
            <td style="padding: 14px 16px; color: var(--text-muted);">
                <?php echo htmlspecialchars($trader['trader_phone']); ?>
            </td>
            <td style="padding: 14px 16px; color: var(--text-muted); font-family: monospace;">
                <?php echo htmlspecialchars($trader['trader_cccd']); ?>
            </td>
            <td style="padding: 14px 16px; color: var(--text-muted); max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo htmlspecialchars($trader['trader_address']); ?>">
                <?php echo htmlspecialchars($trader['trader_address']); ?>
            </td>
