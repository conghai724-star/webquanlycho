            ...
            <?php if (!empty($traders)): ?>
                ...
                <?php foreach ($traders as $index => $trader): ?>
                    ...
                    <tr>
                        ...
                        <td class="wrap"><?php echo htmlspecialchars($trader['trader_fullname']); ?></td>
                        <td><?php echo htmlspecialchars($trader['trader_phone']); ?></td>
                        <td><?php echo htmlspecialchars($trader['trader_cccd']); ?></td>
