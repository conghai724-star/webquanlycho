...
<div class="card">
        <div class="card-header" style="border-bottom: 1px solid var(--border-color); padding: 16px 20px;">
            <div class="card-title" style="font-size: 16px; font-weight: 600;">Thông tin khai báo chợ mới</div>
        </div>
            ...
            <form id="form-add-market" method="POST" action="<?php echo BASE_URL; ?>api/addMarket" data-native-submit="true">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Ví dụ: Chợ Bình Tây" required>
                    </div>
                    <!-- Mã chợ -->
                    <div class="form-group">
                        ...
                        <input type="text" id="market_code" name="market_code" class="form-control" placeholder="Ví dụ: CHO_BT" style="text-transform: uppercase;" required>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Số điện thoại BQL">
                    </div>
                    <!-- Email -->
                    <div class="form-group">
                        <label class="form-label" for="email" style="font-weight: 500;">Email liên hệ</label>
                        <input type="email" id="email" name="email" class="form-control" placeholder="Email BQL">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 24px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="manager_name" name="manager_name" class="form-control" placeholder="Họ tên Trưởng ban">
                    </div>
                    <!-- Trạng thái -->
                    <div class="form-group">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 12px;">
                    ...
                    <button type="submit" class="btn btn-primary" style="height: 38px; display: inline-flex; align-items: center; justify-content: center; gap: 6px;">
                        <i class="fa-solid fa-check"></i> Tạo Chợ Mới
                    </button>
                </div>
            </form>
        </div>
...
$(document).ready(function() {
    ...
    $('#form-add-market').on('submit', function(e) {
        e.preventDefault();
        e.stopPropagation();
        var form = this;
        var $form = $(this);
