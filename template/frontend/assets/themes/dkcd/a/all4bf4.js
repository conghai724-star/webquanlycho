!(function (e, t) {
  ...
  function v(e, t, n, i) {
    var o,
      ...
      d = (ve.cssNumber[t] || ("px" !== c && +l)) && ze.exec(ve.css(e, t));
    if (d && d[3] !== c) {
      (c = c || d[3]), (n = n || []), (d = +l || 1);
      do (r = r || ".5"), (d /= r), ve.style(e, t, d + c);
      while (r !== (r = a() / l) && 1 !== r && --s);
    }
    return (
      n &&
  ...
  function y(e, t) {
    for (var n, i, o = [], r = 0, s = e.length; s > r; r++)
      (i = e[r]),
        i.style &&
          ((n = i.style.display),
          t
  ...
  function E(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        ...
        for (o in c)
          for (n = 0, i = c[o].length; i > n; n++) ve.event.add(t, o, c[o][n]);
      }
      Me.hasData(e) &&
        ((a = Me.access(e)), (l = ve.extend({}, a)), Me.set(t, l));
    }
  }
  function j(e, t) {
  ...
  function D(e, t, i, o) {
    ...
    var r,
      ...
      h = t[0],
      v = ve.isFunction(h);
    if (v || (p > 1 && "string" == typeof h && !fe.checkClone && it.test(h)))
    ...
    if (
      ...
      for (a = ve.map(m(r, "script"), $), l = a.length; p > u; u++)
        (c = r),
          u !== f &&
            ((c = ve.clone(c, !0, !0)), l && ve.merge(a, m(c, "script"))),
          i.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, ve.map(a, A), u = 0; l > u; u++)
          (c = a[u]),
            Ve.test(c.type || "") &&
              ...
              (c.src
                ...
                : n(c.textContent.replace(rt, ""), d));
    }
    return e;
  }
  function N(e, t, n) {
    for (var i, o = t ? ve.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || ve.cleanData(m(i)),
        i.parentNode &&
          (n && ve.contains(i.ownerDocument, i) && w(m(i, "script")),
  ...
  function M(e, t, n, i, o) {
    ...
    for (
      ...
      "margin" === n && (s += ve.css(e, n + Re[r], !0, o)),
        i
          ? ("content" === n && (s -= ve.css(e, "padding" + Re[r], !0, o)),
            "margin" !== n &&
              (s -= ve.css(e, "border" + Re[r] + "Width", !0, o)))
          : ((s += ve.css(e, "padding" + Re[r], !0, o)),
            "padding" !== n &&
              (s += ve.css(e, "border" + Re[r] + "Width", !0, o)));
    return s;
  }
  function F(e, t, n) {
    ...
    return at.test(r)
      ...
      : ((i = s && (fe.boxSizingReliable() || r === e.style[t])),
        ...
        (r = parseFloat(r) || 0),
        r + M(e, t, n || (s ? "border" : "content"), i, o) + "px");
  }
  ...
  function B(e, t, n) {
    for (
      var i,
        o = (_.tweeners[t] || []).concat(_.tweeners["*"]),
        r = 0,
        s = o.length;
      s > r;
      r++
      ...
      for (i in f)
        l ||
          (g
            ...
            : (g = qe.access(e, "fxshow", { display: c })),
          r && (g.hidden = !v),
          v && y([e], !0),
          p.done(function () {
  ...
  function _(e, t, n) {
    var i,
      ...
      d = c.props;
    for (X(d, c.opts.specialEasing); s > r; r++)
      if ((i = _.prefilters[r].call(c, e, d, c.opts)))
        return (
      ...
      function () {
        ...
        for (
          "boolean" == typeof s && ((c = s), (s = arguments[a] || {}), a++),
            "object" == typeof s || ve.isFunction(s) || (s = {}),
            a === l && ((s = this), a--);
          l > a;
          a++
        )
      ...
      isPlainObject: function (e) {
        ...
        return !(
          ...
          ((t = ie(e)) &&
            ...
            "function" != typeof n || ue.call(n) !== pe))
        );
      },
  ...
  var be = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : z) !== H && L(t), (t = t || H), P)
      ) {
        if (11 !== h && (l = ye.exec(e)))
          if ((o = l[1])) {
            if (9 === h) {
                    ...
                    return n
                      ...
                      : ((n =
                        ...
                        (!T.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === H || (e.ownerDocument === z && I(z, e))
                            ? -1
                            : t === H || (t.ownerDocument === z && I(z, t))
                            ? 1
                            : D
                            ? ee(D, e) - ee(D, t)
                            : 0
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === d.length)) {
            if (
              ...
              if (
                ((t = (k.find.ID(s.matches[0].replace(we, be), t) || [])[0]),
                !t)
              )
                return n;
  ...
  (ve.filter = function (e, t, n) {
    ...
    ve.fn.extend({
        ...
        if ("string" != typeof e)
          return this.pushStack(
            ve(e).filter(function () {
              for (t = 0; i > t; t++) if (ve.contains(o[t], this)) return !0;
            })
          );
        for (n = this.pushStack([]), t = 0; i > t; t++) ve.find(e, o[t], n);
      ...
      is: function (e) {
        return !!r(
          this,
          "string" == typeof e && ke.test(e) ? ve(e) : e || [],
          !1
        ).length;
      },
    });
  ...
  ve.fn.extend({
    has: function (e) {
      ...
      return this.filter(function () {
        for (var e = 0; n > e; e++) if (ve.contains(this, t[e])) return !0;
      });
    },
      ...
      function (e, t) {
        ve.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (De[e] || ve.uniqueSort(o), je.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    ve.extend({
      ...
      ready: function (e) {
        (e === !0 ? --ve.readyWait : ve.isReady) ||
          ((ve.isReady = !0),
          (e !== !0 && --ve.readyWait > 0) || He.resolveWith(ne, [ve]));
      },
    }),
    (ve.ready.then = He.then),
    "complete" === ne.readyState ||
    ("loading" !== ne.readyState && !ne.documentElement.doScroll)
      ? e.setTimeout(ve.ready)
      : (ne.addEventListener("DOMContentLoaded", u),
        ...
        if (void 0 !== i) {
          if (void 0 !== t) {
            Array.isArray(t)
              ...
              : ((t = ve.camelCase(t)), (t = t in i ? [t] : t.match(Ne) || [])),
              (n = t.length);
            for (; n--; ) delete i[t[n]];
          }
    ...
    ve.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = Me.get(r)), 1 === r.nodeType && !qe.get(r, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
                ((i = s[n].name),
      ...
      queue: function (e, t, n) {
        ...
        return e
          ? ((t = (t || "fx") + "queue"),
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = qe.access(e, t, ve.makeArray(n)))
                : i.push(n)),
            i || [])
          : void 0;
      },
  ...
  (ve.event = {
      ...
      if (g)
        for (
          n.handler && ((r = n), (n = r.handler), (o = r.selector)),
            o && ve.find.matchesSelector(Je, o),
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ve.event.handlers.call(this, a, c), t = 0;
    ...
    special: {
      ...
      click: {
        trigger: function () {
          return "checkbox" === this.type && this.click && o(this, "input")
            ? (this.click(), !1)
            : void 0;
        },
        _default: function (e) {
  ...
  ve.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = m(a), r = m(e), i = 0, o = r.length; o > i; i++) j(r[i], s[i]);
      if (t)
        if (n)
          for (r = r || m(e), s = s || m(a), i = 0, o = r.length; o > i; i++)
            E(r[i], s[i]);
        else E(e, a);
      return (
        (s = m(a, "script")), s.length > 0 && w(s, !l && m(e, "script")), a
      );
    },
            ...
            if (
              ...
              try {
                for (; i > n; n++)
                  (t = this[n] || {}),
                    1 === t.nodeType &&
                      (ve.cleanData(m(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (o) {}
            }
      ...
      replaceWith: function () {
        ...
        return D(
          ...
          function (t) {
            ...
            ve.inArray(this, e) < 0 &&
              (ve.cleanData(m(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    ve.each(
      ...
      function (e, t) {
        ve.fn[e] = function (e) {
          for (var n, i = [], o = ve(e), r = o.length - 1, s = 0; r >= s; s++)
      ...
      ve.cssHooks[t] = {
        ...
        set: function (e, n, i) {
          var o,
            ...
            s =
              i &&
              M(e, t, i, "border-box" === ve.css(e, "boxSizing", !1, r), r);
          return (
            s &&
              (o = ze.exec(n)) &&
              "px" !== (o[3] || "px") &&
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : xt.test(e.nodeName) || (Tt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n
          ...
          : this.each(function () {
              var t, i, o, r;
              if ("string" === n)
                for (i = 0, o = ve(this), r = e.match(Ne) || []; (t = r[i++]); )
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || e === !1 ? "" : qe.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
      ...
      (ve.valHooks[this] = {
        set: function (e, t) {
          return Array.isArray(t)
            ? (e.checked = ve.inArray(ve(e).val(), t) > -1)
            : void 0;
        },
      }),
        fe.checkOn ||
    ...
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !u.noBubble && !ve.isWindow(i)) {
          for (
            l = u.delegateType || f, St.test(l + f) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            p.push(s), (a = s);
        ...
        for (r = 0; (s = p[r++]) && !t.isPropagationStopped(); )
          (t.type = r > 1 ? l : u.bindType || f),
            (d = (qe.get(s, "events") || {})[t.type] && qe.get(s, "handle")),
            d && d.apply(s, n),
            (d = c && s[c]),
            d &&
              d.apply &&
    ...
    ve.extend({
      ...
      ajax: function (t, n) {
            ...
            c
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = b.state), (p = b.data), (f = b.error), (c = !f)))
              : ((f = T), (!t && T) || ((T = "error"), 0 > t && (t = 0))),
            (k.status = t),
            (k.statusText = (n || T) + ""),
        ...
        (u = ve.event && h.global),
          ...
          h.ifModified &&
            (ve.lastModified[r] &&
              k.setRequestHeader("If-Modified-Since", ve.lastModified[r]),
            ve.etag[r] && k.setRequestHeader("If-None-Match", ve.etag[r])),
  ...
  ve.ajaxSetup({
    ...
    ve.each(["top", "left"], function (e, t) {
      ve.cssHooks[t] = H(fe.pixelPosition, function (e, n) {
        return n
          ? ((n = L(e, t)), at.test(n) ? ve(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
  ...
  return (
    (ve.noConflict = function (t) {
      return (
        e.$ === ve && (e.$ = Vt), t && e.jQuery === ve && (e.jQuery = Yt), ve
      );
    }),
    t || (e.jQuery = e.$ = ve),
    ve
...
jQuery(function ($) {
  ...
  //   $('#pYcc').fadeIn(400);
  // },15000);
  // $("#pYcc-ovl,#pYcc-tuchoi").click(function(){
  //   $('#pYcc').fadeOut(400);
  //   setTimeout(function(){
  //     $('#pYcc').fadeIn(400);
  //   },40000);
  ...
  // $("#pGs-ovl, .pGs-close, #pGs-close, #pGsL-cls,#pGsSui-cls, #pGsHm-cls, #pGsHmtt-cls, #pGsKhh-cls").click(function(){
  //   console.log('click close PGs');
  //   $('.pGs').fadeOut(400);
  //   setTimeout(function(){
  //     $('.pGs').fadeIn(400);
  //   },35000);
  ...
  // $("#pGs-ovl, #pGsHmtt-cls").click(function(){
  //   console.log('out');
  //   $('#pGsHmtt').fadeOut(400);
  // });

  // $("#phmtt-gs, #phmtt-gsmb, #sc-udm_popup").click(function(){
  //   console.log('click');
  //   $('#pGsHmtt').fadeIn(400);
  // });
  ...
  //   $('#pGsL').fadeIn(400);
  // },35000);
  // $("#pGs-ovl, #pGsL-cls").click(function(){
  //   $('#pGsL').fadeOut(400);
  //   setTimeout(function(){
  //     $('#pGsL').fadeIn(400);
  //   },35000);
  ...
  //   $("#pGsL_btn a").toggleClass('active');
  // }, 800);

  
  if ($(window).width() < 991.98) {
    $(".is_pc,.hidden_mobi").remove();
    $(window).scroll(function() {
        if ($(this).scrollTop() > 65) {
          $('.mnm2').addClass('mnm2c');
          $('#popup-top').addClass('show');
          $('#header').addClass('stuck');
        } else {
          $('.mnm2').removeClass('mnm2c');
          $('#popup-top').removeClass('show');
          $('#header').removeClass('stuck');
        }
    });
    // $("ul.sub-menu").before(
    //   '<span class="icDropMenu"><i class="far fa-angle-down"></i></span>'
    // );
    $("ul.sub-menu").parent().addClass("hasChildren");

    $("#mainMenu-btn,#ptop-icmenu").click(function () {
      $("#menuM").addClass("in");
      $("#ovl-menuM").show();
      console.log('click');
    });
    $("#menuM-cls,#ovl-menuM").click(function () {
    ...
    $("#search-btn").click(function () {
      $("#header-bottom-search").toggle(200);
    });

  }
  if ($(window).width() > 991.99) {
    $(".is_mobi,.hidden_pc").remove();
    $(window).scroll(function() {
      if ($(this).scrollTop() > 65) {
        $('#headerMid').addClass('stuck');
      } else {
        $('#headerMid').removeClass('stuck');
      }
  });
  }
  ...
  $(".hasChildren").click(function () {
    if ($(this).hasClass("active")) {
      ...
      $("#menuM-lst > li").removeClass("active");
  ...
  $(".hasChildren").click(function () {
    const phoneNumberMap = {
      "nam-khoa": ["0222 730 0222", "086 2345 169"],
      "phu-khoa": ["0222 730 0222", "086 5678 169"],
      "benh-hau-mon": ["0222 730 0222", "033 6789 169"],
      "benh-xa-hoi": ["0222 730 0222", "038 3456 169"],
      default: ["0222 730 0222", "086 5678 169"],
    };

    const selectedClass = $(this)
      .attr("class")
      .split(" ")
      .find((c) => c in phoneNumberMap);
    const [sdt1, sdt2] = phoneNumberMap[selectedClass || "default"];

    $("#p1 a").text(sdt1).attr("href", `tel:${sdt1}`);
    $("#p2 a").text(sdt2).attr("href", `tel:${sdt2}`);
  });

  $(document).ready(function () {
    $(".hasChildren:first").addClass("active");
    $("#p2 a").text("086 2345 169").attr("href", `tel:086 2345 169`);
  });
  ...
  $(".slider").slick({
    ...
    autoplaySpeed: 7000,
    prevArrow:
      '<button class="slick_arrow sbanner_prev" aria-label="button"><img src="https://chuabenhtriohanoi.com/public/desktop2/images/back.png" alt="back"></button>',
    nextArrow:
      '<button class="slick_arrow sbanner_next" aria-label="button"><img src="https://chuabenhtriohanoi.com/public/desktop2/images/next.png" alt="next"></button>',
  });
});

// Lời chào livechat giả lập
function setupBoxLive(id, items, options = {}) {
  const el = document.getElementById(id);
  if (!el) {
    console.warn(`[setupBoxLive] Không tìm thấy phần tử có id = ${id}`);
    return;
  }

  const link = el.querySelector(".content");
  const form = el.querySelector(".formLive");
  const closeBtn = el.querySelector("#pFakeLive-close");

  const config = {
    showDelay: options.showDelay ?? 15000, // ms
    skipShowDelayOnReopen: options.skipShowDelayOnReopen ?? true
  };

  // Gán mặc định cho mỗi item
  ...
  function showBox() {
    console.log("[setupBoxLive] Hiển thị box");
  ...
  function showItem(index) {
    if (index >= items.length) {
      console.log("[setupBoxLive] Đã hiển thị hết các item, chờ người dùng đóng");
      return;
    }
    ...
    if (link) link.innerHTML = item.content || "";

    // Quản lý form hiển thị
    if (form) {
      if (item.showForm) {
    ...
    // Hiện nút Close nếu là item cuối
    if (closeBtn) {
      closeBtn.style.display = index === items.length - 1 ? "inline" : "none";
    }

    // Hiển thị item kế tiếp (nếu có)
  ...
  // Chờ showDelay để hiện box
  setTimeout(showBox, config.showDelay);

  // Gán sự kiện đóng box
  if (closeBtn) {
    closeBtn.addEventListener("click", () => {
      if (currentIndex === items.length - 1) {
        hideBox();
      } else {
        console.log("[setupBoxLive] Nút Close bị ẩn ở item chưa cuối");
      }
    });
  }
}

$("body").on("click", ".btn-popup-callto", function () {
  $('#popup_callto').show(300);
});

$("body").on("click", "#callto_close, #callto_ovl", function () {
  $('#popup_callto').hide(300);
});
...
jQuery(function ($) {
  let crm_url = "https://crm.phongkhamvietsing.com/";
  let timeErr = 2000;
  let countErr = 0;
    ...
    var send_data = function (that) {
      ...
      if (chogui == 1) {
        ...
        if (
          ...
          const popGs = that.find("input[name='popGs']");
          const popGss = [];
          for (const checkbox of popGs) {
            if (checkbox.checked) {
              popGss.push(checkbox.value);
            }
          }
          if (popGss !== undefined && popGss != "undefined" && popGss != "") {
            content = " " + popGss + ". " + content;
          }
...
jQuery(function ($) {
  $.fn.form_contact = function (options) {
    ...
    var options = $.extend(defaults, options);
    var html =
      '<div class="form-contact" id="d-form-contact">' +
      '<div class="in">' +
...
jQuery(function ($) {
  if ($(".d-dathen").length) $(".d-dathen").form_contact({});

  $('#list_cmts .loadmore p').click(function(){
		$('#list_cmts .loadmore-comments').toggleClass('active');
