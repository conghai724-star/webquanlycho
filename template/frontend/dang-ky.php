      ...
      <div class="register-card">
        ...
        <form class="register-form active" data-form="candidate" action="#" method="post" novalidate>
          <div class="register-grid">
            <div class="register-field full" data-field="fullname"><label for="candidateFullname">Họ và tên <span style="color: #ff0000;">*</span></label><div class="register-input"><i class="ti ti-user"></i><input id="candidateFullname" name="fullname" type="text" autocomplete="name" placeholder="Nhập họ và tên" data-required data-label="Họ và tên"></div><div class="register-error"></div></div>
            <div class="register-field"><label for="candidateEmail">Email <span style="color: #ff0000;">*</span></label><div class="register-input"><i class="ti ti-mail"></i><input id="candidateEmail" name="email" type="email" autocomplete="email" placeholder="vidu@email.com" data-required data-email data-label="Email"></div><div class="register-error"></div></div>
            <div class="register-field"><label for="candidatePhone">Số điện thoại <span style="color: #ff0000;">*</span></label><div class="register-input"><i class="ti ti-phone"></i><input id="candidatePhone" name="phone" type="tel" autocomplete="tel" placeholder="09xxxxxxxx" data-required data-phone data-label="Số điện thoại"></div><div class="register-error"></div></div>
            <div class="register-field"><label for="candidatePassword">Mật khẩu <span style="color: #ff0000;">*</span></label><div class="register-input" style="position:relative;"><i class="ti ti-lock"></i><input id="candidatePassword" name="password" type="password" autocomplete="new-password" placeholder="Tối thiểu 8 ký tự" style="padding-right:44px;" data-required data-password data-label="Mật khẩu"></div><div class="register-error"></div></div>
            <div class="register-field"><label for="candidateConfirm">Xác nhận mật khẩu <span style="color: #ff0000;">*</span></label><div class="register-input" style="position:relative;"><i class="ti ti-lock-check"></i><input id="candidateConfirm" name="confirm_password" type="password" autocomplete="new-password" placeholder="Nhập lại mật khẩu" style="padding-right:44px;" data-required data-match="candidatePassword" data-label= "Xác nhận mật khẩu"></div><div class="register-error"></div></div>
          </div>
